...
var mobileMenuBtns = document.querySelector('.mobile-menu-btns');
mobileMenuBtns.addEventListener('click', function () {
  document.body.classList.remove('mobile-menu-open');
});
var mobileRarityMenuBtn = document.querySelector('.mobile-rarity-menu-btn');
mobileRarityMenuBtn.addEventListener('click', function () {
  document.body.classList.toggle('mobile-rarity-menu-open');
});
var teammates = document.querySelector('.teammate');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcryptobuddiez_com"] = self["webpackChunkcryptobuddiez_com"] || [];
